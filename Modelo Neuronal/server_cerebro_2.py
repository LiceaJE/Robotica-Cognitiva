...
# ── Nombres de archivo que genera Internal_model2.ipynb ──────────────────────
...
def iniciar_servidor_cerebro():
    ...
    while True:
        ...
        try:
            while True:
                # Formato recibido desde e-puck_25.c:
                # "DistIzq,DistDer,LuzIzq,LuzDer,SueloIzq,SueloDer,Bat,Aburr"
